...
function WorkspaceSettingsPage() {
  ...
  if (!canUpdateWorkspace && !canTransferOwnership) {
    return (
    ...
    <div className="mx-auto max-w-4xl space-y-6">
      <header className="space-y-2">
        ...
        <p className="text-sm text-muted-foreground">
          Gérez les informations courantes de {workspace.name} et, si vous êtes propriétaire, le transfert exceptionnel de sa propriété.
        </p>
      </header>
