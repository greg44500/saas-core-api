...
/**
 * Valide les filtres de consultation globale des AuditLogs Platform.
 *
 * Le schéma reste strict afin qu'aucun opérateur MongoDB ou filtre implicite
 * ne puisse être injecté depuis la query string.
 */
const platformAuditLogQuerySchema = z
    .strictObject({
        page: z.coerce
            .number()
            .int()
