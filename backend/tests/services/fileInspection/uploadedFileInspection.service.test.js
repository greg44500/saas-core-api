...
describe("Uploaded file inspection service", () => {
    it(
        "retourne les métadonnées vérifiées lorsque toutes les étapes réussissent",
        async () => {
            const dependencies =
                createDependencies();
            ...
            /*
             * Un résultat sain reste dans la quarantaine jusqu'à ce que le
    ...
    it(
        "détruit le temporaire et qualifie le rejet lorsqu'une menace est détectée",
        async () => {
            const dependencies =
                createDependencies();
    ...
    it(
        "détruit le temporaire et qualifie l'échec lorsque le scanner est indisponible",
        async () => {
            const dependencies =
                createDependencies();
    ...
    it(
        "nettoie le temporaire et propage l'erreur initiale lorsqu'une inspection échoue",
        async () => {
            const dependencies =
                createDependencies();
    ...
    it(
        "conserve les deux erreurs lorsque le traitement et le nettoyage échouent",
        async () => {
            const dependencies =
                createDependencies();
