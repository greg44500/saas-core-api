...
import {
    updatePlatformPlan,
} from '../../../modules/platform/plans/services/updatePlatformPlan.service.js';
...
describe('updatePlatformPlan', () => {
    ...
    it('refuse explicitement l’archivage via le service de mise à jour', async () => {
        await expect(
            updatePlatformPlan({
                planId,
                planData: {
    ...
    it('met à jour uniquement un plan non archivé', async () => {
        await updatePlatformPlan({
            planId,
            planData,
            actorId,
    ...
    it('crée un audit PLAN_UPDATED dans la même transaction', async () => {
        await updatePlatformPlan({
            planId,
            planData,
            actorId,
    ...
    it('retourne le DTO administratif du plan mis à jour', async () => {
        const result =
            await updatePlatformPlan({
                planId,
                planData,
