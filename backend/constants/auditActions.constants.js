...
const AUDIT_STATUS_REGISTRY = freezeRegistry({
    SUCCESS: { value: 'success', label: 'Réussie' },
    FAILED: { value: 'failed', label: 'Échouée' },
});

const AUDIT_ENTITY_TYPE_REGISTRY = freezeRegistry({
    AUTH_SESSION: { value: 'AuthSession', label: 'Session' },
    COMMERCIAL_INVITATION: {
        value: 'CommercialInvitation',
        label: 'Invitation commerciale',
    },
    ENTITLEMENT_OVERRIDE: { value: 'EntitlementOverride', label: 'Dérogation' },
    FILE: { value: 'File', label: 'Fichier' },
    ORGANIZATION: { value: 'Organization', label: 'Organisation' },
    PLAN: { value: 'Plan', label: 'Plan' },
    PLATFORM_INVITATION: {
        value: 'PlatformInvitation',
        label: 'Invitation de la Plateforme',
    },
    PLATFORM_ROLE: { value: 'PlatformRole', label: 'Rôle de la Plateforme' },
    PLATFORM_TEAM_MEMBER: {
        value: 'PlatformTeamMember',
        label: 'Membre de l’équipe de la Plateforme',
    },
    ROLE: { value: 'Role', label: 'Rôle d’espace de travail' },
    SUBSCRIPTION: { value: 'Subscription', label: 'Abonnement' },
    USER: { value: 'User', label: 'Utilisateur' },
    WORKSPACE: { value: 'Workspace', label: 'Espace de travail' },
...
const AUDIT_ACTION_REGISTRY = freezeRegistry({
    LOGIN_SUCCESS: { value: 'LOGIN_SUCCESS', label: 'Connexion réussie' },
    LOGIN_FAILED: { value: 'LOGIN_FAILED', label: 'Échec de connexion' },
    LOGOUT: { value: 'LOGOUT', label: 'Déconnexion' },
    LOGOUT_ALL: { value: 'LOGOUT_ALL', label: 'Déconnexion de toutes les sessions' },
    PASSWORD_CHANGED: { value: 'PASSWORD_CHANGED', label: 'Mot de passe modifié' },
    PASSWORD_RESET_COMPLETED: {
        value: 'PASSWORD_RESET_COMPLETED',
        label: 'Mot de passe réinitialisé',
    },

    USER_CREATED: { value: 'USER_CREATED', label: 'Utilisateur créé' },
    USER_PROFILE_UPDATED: { value: 'USER_PROFILE_UPDATED', label: 'Profil utilisateur modifié' },
    USER_DISABLED: { value: 'USER_DISABLED', label: 'Utilisateur désactivé' },
    USER_ENABLED: { value: 'USER_ENABLED', label: 'Utilisateur réactivé' },
    USER_DELETION_REQUESTED: {
        value: 'USER_DELETION_REQUESTED',
        label: 'Suppression de l’utilisateur demandée',
    },
    USER_CLOSED: { value: 'USER_CLOSED', label: 'Utilisateur clôturé' },
    USER_PLATFORM_ROLE_UPDATED: {
        value: 'USER_PLATFORM_ROLE_UPDATED',
        label: 'Ancien rôle Plateforme de l’utilisateur modifié',
    },

    SESSION_REVOKED: { value: 'SESSION_REVOKED', label: 'Session révoquée' },
    SESSION_REUSE_DETECTED: {
        value: 'SESSION_REUSE_DETECTED',
        label: 'Réutilisation de session détectée',
    },

    WORKSPACE_CREATED: { value: 'WORKSPACE_CREATED', label: 'Espace de travail créé' },
    WORKSPACE_UPDATED: { value: 'WORKSPACE_UPDATED', label: 'Espace de travail modifié' },
    WORKSPACE_SUSPENDED: { value: 'WORKSPACE_SUSPENDED', label: 'Espace de travail suspendu' },
    WORKSPACE_REACTIVATED: { value: 'WORKSPACE_REACTIVATED', label: 'Espace de travail réactivé' },
    WORKSPACE_ARCHIVED: { value: 'WORKSPACE_ARCHIVED', label: 'Espace de travail archivé' },
    WORKSPACE_CLOSED: { value: 'WORKSPACE_CLOSED', label: 'Espace de travail clôturé' },
    WORKSPACE_OWNERSHIP_TRANSFERRED: {
        value: 'WORKSPACE_OWNERSHIP_TRANSFERRED',
        label: 'Propriété de l’espace de travail transférée',
    },

    MEMBER_INVITED: { value: 'MEMBER_INVITED', label: 'Membre d’espace invité' },
    ...
    MEMBER_ROLE_UPDATED: { value: 'MEMBER_ROLE_UPDATED', label: 'Rôle d’un membre d’espace modifié' },
    MEMBER_SUSPENDED: { value: 'MEMBER_SUSPENDED', label: 'Membre d’espace suspendu' },
    MEMBER_REMOVED: { value: 'MEMBER_REMOVED', label: 'Membre d’espace retiré' },
    ...
    ROLE_CREATED: { value: 'ROLE_CREATED', label: 'Rôle d’espace créé' },
    ROLE_UPDATED: { value: 'ROLE_UPDATED', label: 'Rôle d’espace modifié' },
    ROLE_DELETED: { value: 'ROLE_DELETED', label: 'Rôle d’espace supprimé' },

    PLAN_CREATED: { value: 'PLAN_CREATED', label: 'Plan créé' },
    PLAN_UPDATED: { value: 'PLAN_UPDATED', label: 'Plan modifié' },
    PLAN_ARCHIVED: { value: 'PLAN_ARCHIVED', label: 'Plan archivé' },

    SUBSCRIPTION_CREATED: { value: 'SUBSCRIPTION_CREATED', label: 'Abonnement créé' },
    SUBSCRIPTION_UPDATED: { value: 'SUBSCRIPTION_UPDATED', label: 'Abonnement modifié' },
    SUBSCRIPTION_CANCELLATION_SCHEDULED: {
        value: 'SUBSCRIPTION_CANCELLATION_SCHEDULED',
        label: 'Résiliation programmée',
    },
    SUBSCRIPTION_CANCELED: { value: 'SUBSCRIPTION_CANCELED', label: 'Abonnement résilié' },
    SUBSCRIPTION_EXPIRED: { value: 'SUBSCRIPTION_EXPIRED', label: 'Abonnement expiré' },
    ...
    SUBSCRIPTION_RESUMED: { value: 'SUBSCRIPTION_RESUMED', label: 'Abonnement repris' },
    ...
    FILE_UPLOADED: { value: 'FILE_UPLOADED', label: 'Fichier ajouté' },
    FILE_UPLOAD_REJECTED: { value: 'FILE_UPLOAD_REJECTED', label: 'Ajout de fichier refusé' },
    FILE_DELETED: { value: 'FILE_DELETED', label: 'Fichier supprimé' },
    FILE_PURGED: { value: 'FILE_PURGED', label: 'Fichier purgé' },

    ORGANIZATION_CREATED: { value: 'ORGANIZATION_CREATED', label: 'Organisation créée' },
    ORGANIZATION_UPDATED: { value: 'ORGANIZATION_UPDATED', label: 'Organisation modifiée' },
    ORGANIZATION_SUSPENDED: { value: 'ORGANIZATION_SUSPENDED', label: 'Organisation suspendue' },
